...
const LASZIP_GPSTIME_MULTI_UNCHANGED = 511; // LASZIP_GPSTIME_MULTI - LASZIP_GPSTIME_MULTI_MINUS + 1;
const LASZIP_GPSTIME_MULTI_CODE_FULL = 512; // LASZIP_GPSTIME_MULTI - LASZIP_GPSTIME_MULTI_MINUS + 2;

const LASZIP_GPSTIME_MULTI_TOTAL = 516; // LASZIP_GPSTIME_MULTI - LASZIP_GPSTIME_MULTI_MINUS + 6;
