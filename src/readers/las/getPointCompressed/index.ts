import { LAZHeaderItemType } from '../types';
import { toLASClassification } from '../getPoint';
...
export class LASrgba extends CopyDataView {
  /**  @param data - 12 bytes (4 bytes each for R, G, B) */
...
export class LASWavePacket extends CopyDataView {
  /** @param data - 29 */
   ...
   */
  static rawToVectorPoint(data: DataView, point: VectorPointM<LASFormat>): void {
    const lasWavePacket = new LASWavePacket(data);
