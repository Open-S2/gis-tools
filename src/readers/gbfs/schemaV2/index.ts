 ...
 */
export class GBFSReaderV2 implements FeatureIterator<
  undefined,
  Properties,
  GBFSFeaturePropertiesV2
> {
  version = 2;
   ...
   * @yields {GBFSFeaturesV2} - an iterator that contains shapes, stops, location data, and routes
   */
