/**
 * # GBFS System Calendar V1
 * Describes the operating calendar for a system.
 *
 * ## Links
 * - [GBFS Specification](https://github.com/MobilityData/gbfs/blob/v1.1/gbfs.md#system_calendarjson)
 */
export const gbfsSystemCalendarSchemaV1 = {
