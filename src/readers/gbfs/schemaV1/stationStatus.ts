/**
 * # GBFS Station Status V1
 * Describes the capacity and rental availablility of the station
 *
 * ## Links
 * - [GBFS Specification](https://github.com/MobilityData/gbfs/blob/v1.1/gbfs.md#station_statusjson)
 */
export const gbfsStationStatusSchemaV1 = {
