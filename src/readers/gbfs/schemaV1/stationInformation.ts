/**
 * # GBFS Station Information V1
 * List of all stations, their capacities and locations. REQUIRED of systems utilizing docks.
 *
 * ## Links
 * - [GBFS Specification](https://github.com/MobilityData/gbfs/blob/v1.1/gbfs.md#station_informationjson)
 */
export const gbfsStationInformationSchemaV1 = {
