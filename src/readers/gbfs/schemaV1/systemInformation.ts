/**
 * # GBFS System Information V1
 * Details including system operator, system location, year implemented, URL, contact info, time zone.
 *
 * ## Links
 * - [GBFS Specification](https://github.com/MobilityData/gbfs/blob/v1.1/gbfs.md#system_informationjson)
 */
export const gbfsSystemInformationSchemaV1 = {
