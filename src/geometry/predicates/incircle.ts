import { epsilon, estimate, resulterrbound, scale, splitter, sum, sum_three, vec } from './util.js';
...
function incircleadapt(
  ...
  if (adxtail !== 0 || adytail !== 0) {
    ...
    if (adxtail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum(scale(axtbclen, axtbc, adxtail, _16), _16, scale(len, _16c, 2 * adx, _32), _32, _48),
        _48,
      );
    ...
    if (adytail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum(scale(aytbclen, aytbc, adytail, _16), _16, scale(len, _16c, 2 * ady, _32), _32, _48),
        _48,
      );
  ...
  if (bdxtail !== 0 || bdytail !== 0) {
    ...
    if (bdxtail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum(scale(bxtcalen, bxtca, bdxtail, _16), _16, scale(len, _16c, 2 * bdx, _32), _32, _48),
        _48,
      );
    ...
    if (bdytail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum(scale(bytcalen, bytca, bdytail, _16), _16, scale(len, _16c, 2 * bdy, _32), _32, _48),
        _48,
      );
  ...
  if (cdxtail !== 0 || cdytail !== 0) {
    ...
    if (cdxtail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum(scale(cxtablen, cxtab, cdxtail, _16), _16, scale(len, _16c, 2 * cdx, _32), _32, _48),
        _48,
      );
    ...
    if (cdytail !== 0) {
      ...
      finlen = finadd(
        finlen,
        sum(scale(cytablen, cytab, cdytail, _16), _16, scale(len, _16c, 2 * cdy, _32), _32, _48),
        _48,
      );
