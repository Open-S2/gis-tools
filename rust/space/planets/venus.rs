...
pub const VENUS_RADIUS_EQUATORIAL: f64 = 6_051_800.0;
/// Venus' polar radius in meters
pub const VENUS_RADIUS_POLAR: f64 = 6_051_800.0;
/// The average circumference of Venus in meters.
pub const VENUS_CIRCUMFERENCE: f64 = 2.0 * core::f64::consts::PI * VENUS_RADIUS; // 38_024_580.84198942; // 2.0 * Math.PI * VENUS_RADIUS;
/// The altitude of the highest known point on Venus in meters.
/// https://en.wikipedia.org/wiki/Maxwell_Montes
pub const VENUS_HIGHEST_ALTITUDE: f64 = 11_000.0;
/// The altitude of the lowest known point on Venus in meters.
/// https://en.wikipedia.org/wiki/List_of_Solar_System_extremes
pub const VENUS_LOWEST_ALTITUDE: f64 = -3_000.0;
