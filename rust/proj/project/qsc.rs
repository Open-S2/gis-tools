...
//     } else {
//         theta = atan2(y, x);
//         if (fabs(theta) <= FRAC_PI_4) {
//             *area = pj_qsc_ns::AREA_0;
//         } else if (theta > FRAC_PI_4 && theta <= FRAC_PI_2 + FRAC_PI_4) {
//             *area = pj_qsc_ns::AREA_1;
//             theta -= FRAC_PI_2;
//         } else if (theta > FRAC_PI_2 + FRAC_PI_4 ||
//                    theta <= -(FRAC_PI_2 + FRAC_PI_4)) {
...
//         phi = FRAC_PI_2 - lat;
//         if (longitude >= FRAC_PI_4 && longitude <= FRAC_PI_2 + FRAC_PI_4) {
//             area = pj_qsc_ns::AREA_0;
//             theta = longitude - FRAC_PI_2;
//         } else if (longitude > FRAC_PI_2 + FRAC_PI_4 ||
//                    longitude <= -(FRAC_PI_2 + FRAC_PI_4)) {
//             area = pj_qsc_ns::AREA_1;
...
//             area = pj_qsc_ns::AREA_0;
//             theta = -longitude + FRAC_PI_2;
//         } else if (longitude < FRAC_PI_4 && longitude >= -FRAC_PI_4) {
//             area = pj_qsc_ns::AREA_1;
//             theta = -longitude;
//         } else if (longitude < -FRAC_PI_4 &&
//                    longitude >= -(FRAC_PI_2 + FRAC_PI_4)) {
//             area = pj_qsc_ns::AREA_2;
//             theta = -longitude - FRAC_PI_2;
//         } else {
...
//             longitude = qsc_shift_longitude_origin(longitude, +FRAC_PI_2);
//         } else if (Q->face == pj_qsc_ns::FACE_BACK) {
//             longitude = qsc_shift_longitude_origin(longitude, +PI);
...
//     mu = atan((12.0 / PI) *
//               (theta + acos(sin(theta) * cos(FRAC_PI_4)) - FRAC_PI_2));
...
//     if (Q->face == pj_qsc_ns::FACE_TOP) {
//         phi = acos(cosphi);
//         lp.phi = FRAC_PI_2 - phi;
//         if (area == pj_qsc_ns::AREA_0) {
//             lp.lam = theta + FRAC_PI_2;
...
//         lp.phi = acos(-s) - FRAC_PI_2;
//         lp.lam = atan2(r, q);
//         if (Q->face == pj_qsc_ns::FACE_RIGHT) {
//             lp.lam = qsc_shift_longitude_origin(lp.lam, -FRAC_PI_2);
//         } else if (Q->face == pj_qsc_ns::FACE_BACK) {
//             lp.lam = qsc_shift_longitude_origin(lp.lam, -PI);
//         } else if (Q->face == pj_qsc_ns::FACE_LEFT) {
//             lp.lam = qsc_shift_longitude_origin(lp.lam, +FRAC_PI_2);
//         }
//     }
...
//     if (P->phi0 >= FRAC_PI_2 - FRAC_PI_4 / 2.0) {
//         Q->face = pj_qsc_ns::FACE_TOP;
//     } else if (P->phi0 <= -(FRAC_PI_2 - FRAC_PI_4 / 2.0)) {
//         Q->face = pj_qsc_ns::FACE_BOTTOM;
//     } else if (fabs(P->lam0) <= FRAC_PI_4) {
//         Q->face = pj_qsc_ns::FACE_FRONT;
//     } else if (fabs(P->lam0) <= FRAC_PI_2 + FRAC_PI_4) {
//         Q->face =
