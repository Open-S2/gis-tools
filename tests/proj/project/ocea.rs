...
mod tests {
    use gistools::proj::{
        CoordinateStep, Coords, ObliqueCylindricalEqualAreaProjection, Proj, ProjectCoordinates,
        derive_sphere,
    };
    ...
    fn test_ocea() {
        ...
        // }
        let projection = ObliqueCylindricalEqualAreaProjection::new(proj);

        assert_eq!(projection.code(), -1);
        assert_eq!(projection.name(), "Oblique Cylindrical Equal Area");
        assert_eq!(
            ObliqueCylindricalEqualAreaProjection::names(),
    ...
    fn test_ocea2() {
        ...
        let projection = ObliqueCylindricalEqualAreaProjection::new(proj.clone());
