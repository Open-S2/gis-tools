...
export const TEST_DATA = [
  ...
  {
    code: 'PROJCS["ETRS89 / UTM zone 32N",GEOGCS["ETRS89",DATUM["European_Terrestrial_Reference_System_1989",SPHEROID["GRS 1980",6378137,298.257222101,AUTHORITY["EPSG","7019"]],TOWGS84[0,0,0,0,0,0,0],AUTHORITY["EPSG","6258"]],PRIMEM["Greenwich",0,AUTHORITY["EPSG","8901"]],UNIT["degree",0.0174532925199433,AUTHORITY["EPSG","9122"]],AUTHORITY["EPSG","4258"]],PROJECTION["Extended_Transverse_Mercator"],PARAMETER["latitude_of_origin",0],PARAMETER["central_meridian",9],PARAMETER["scale_factor",0.9996],PARAMETER["false_easting",500000],PARAMETER["false_northing",0],UNIT["metre",1,AUTHORITY["EPSG","9001"]],AXIS["Easting",EAST],AXIS["Northing",NORTH],AUTHORITY["EPSG","25832"]]',
  ...
  {
    code: '+proj=cea +lat_ts=30 +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs +type=crs',
    ll: [-112.50042920000004, 42.036926809999976],
    xy: [-10854747.940137345, 4904271.142640647],
    acc: {
      ll: 5,
      xy: -1,
    },
  ...
  {
    code: '+proj=cea +lat_ts=30 +lon_0=0 +x_0=0 +y_0=0 +R=6371008.7714 +datum=WGS84 +units=m +no_defs +type=crs',
    ll: [-112.50042920000004, 42.036926809999976],
    xy: [-10833539.761402687, 4907780.580660692],
    acc: {
      ll: 3,
      xy: -1,
    },
  ...
  // {
  //   code: '+proj=gstmerc +lon_0=0 +x_0=0 +y_0=0 +R=6371008.7714 +datum=WGS84 +units=m +no_defs',
  //   ll: [-112.50042920000004, 42.036926809999976],
  ...
  // },
  {
    code: '+proj=ortho +lon_0=30 +lat_0=30 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs',
    ll: [-12, 12],
    xy: [-4174544.862725822, -1169723.9077304942],
  },
  {
    code: '+proj=somerc +lat_0=46.95240555555556 +lon_0=7.439583333333333 +k_0=1 +x_0=2600000 +y_0=1200000 +ellps=bessel +towgs84=674.374,15.056,405.346,0,0,0,0 +units=m +no_defs',
    ll: [-12, 12],
    xy: [85532.74540182156, -2564906.626626396],
  },
];
