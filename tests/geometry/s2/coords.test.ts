...
describe('getUNorm', () => {
  expect(getUNorm(0, -1)).toEqual([-1, -1, 0]);
  expect(getUNorm(0, 1)).toEqual([1, -1, 0]);
  // just test faces now
  expect(getUNorm(1, 0)).toEqual([1, 0, 0]);
  expect(getUNorm(2, 0)).toEqual([1, 0, 0]);
  expect(getUNorm(3, 0)).toEqual([-0, 0, 1]);
  expect(getUNorm(4, 0)).toEqual([0, -0, 1]);
  expect(getUNorm(5, 0)).toEqual([0, -1, -0]);
});

describe('getVNorm', () => {
  expect(getVNorm(0, -1)).toEqual([1, 0, 1]);
  expect(getVNorm(0, 1)).toEqual([-1, 0, 1]);
  // just test faces now
  expect(getVNorm(1, 0)).toEqual([0, -0, 1]);
  expect(getVNorm(2, 0)).toEqual([0, -1, -0]);
  expect(getVNorm(3, 0)).toEqual([0, -1, 0]);
  expect(getVNorm(4, 0)).toEqual([1, 0, 0]);
  expect(getVNorm(5, 0)).toEqual([1, 0, 0]);
});
