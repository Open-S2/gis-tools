...
test('utm.tif test', async (): Promise<void> => {
  ...
  expect(bounds).toEqual([688258.223819, 4539289.697337001, 700411.209419, 4555765.966137]);
  ...
  expect(boundsCmp).toEqual([688258.223819, 4539289.697337001, 700411.209419, 4555765.966137]);
});
...
test('pixel_is_point_wgs84.tif test', async (): Promise<void> => {
  ...
  expect(bounds).toEqual([-1, 49, 3, 53]);
  const boundsCmp = cmpImage.getBoundingBox(true);
  expect(boundsCmp).toEqual([-1, 49, 3, 53]);
...
test('byte.tif test', async (): Promise<void> => {
  ...
  const bounds = image.getBoundingBox(false);
  expect(bounds).toEqual([440720, 3750120, 441920, 3751320]);
  const boundsCorrected = image.getBoundingBox(true);
  expect(boundsCorrected).toEqual([
    -117.64108762997199, 33.89153016859067, -117.62819018953391, 33.90241956192106,
  ]);
  const boundsCmp = cmpImage.getBoundingBox();
  expect(boundsCmp).toEqual([440720, 3750120, 441920, 3751320]);
});
...
test('GeogAngularUnitsGeoKey_9114.tif test', async (): Promise<void> => {
  ...
  const bounds = image.getBoundingBox(false);
  expect(bounds).toEqual([130, 31, 131, 32]);
  const boundsCorrected = image.getBoundingBox(true);
  expect(boundsCorrected).toEqual([130, 31, 131, 32]);
  const boundsCmp = cmpImage.getBoundingBox();
  expect(boundsCmp).toEqual([130, 31, 131, 32]);
});
