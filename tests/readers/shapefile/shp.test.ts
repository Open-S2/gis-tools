    ...
    features: [
      {
        ...
        geometry: {
          ...
          coordinates: [
            { x: -123, y: 48, z: 1200, m: { value: 0 } },
            { x: -122, y: 47, z: 2500, m: { value: 0 } },
            { x: -121, y: 46, z: 3600, m: { value: 0 } },
          ],
          is3D: true,
          type: 'MultiPoint',
        },
    ...
    features: [
      {
        geometry: {
          ...
          coordinates: [
            [
              { x: -120, y: 45, z: 800, m: { value: 0 } },
              { x: -119, y: 44, z: 1100, m: { value: 0 } },
              { x: -118, y: 43, z: 2300, m: { value: 0 } },
            ],
            [
              { x: -115, y: 40, z: 0, m: { value: 0 } },
              { x: -114, y: 39, z: 0, m: { value: 0 } },
              { x: -113, y: 38, z: 0, m: { value: 0 } },
            ],
          ],
          is3D: true,
