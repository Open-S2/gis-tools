import { cleanPolygon } from '../src/index.js';
import { cleanCoords, polygon, unkinkPolygon } from '@turf/turf';
...
for (let i = 0; i < 1_000_000; i++) {
  const res = unkinkPolygon(turfPolygon);
...
//  bun run ./benchmarks/clean.ts
// clean:
// GIS-TOOLS Dekink time:  4.916731333
// TURF Dekink time:  15.158280584

// GIS-TOOLS IS 3.083x faster

//  cargo bench --bench clean
// clean_polygon_test/clean
//                         time:   [2.9034 s 2.9281 s 2.9596 s]
